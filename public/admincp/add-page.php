                  ...
                  <div class="col-lg-9">
                    <div class="input-group input-group-sm mb-3">
                      <div class="input-group-prepend">
                        <span class="input-group-text">Tên trang</span>
                      </div>
                      <input type="text" class="form-control" name="title" placeholder="Tên của trang" >
                    </div>
                    <div class="input-group input-group-sm mb-3">
                      <div class="input-group-prepend">
                        <span class="input-group-text">https://manga.ani4vn.com/page/</span>
                      </div>
                      <input type="text" class="form-control" placeholder="Cài đặt đường dẫn cho trang">
                    </div>
