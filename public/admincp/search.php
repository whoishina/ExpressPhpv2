<?php require '../wb-include/wjbu.php'; ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    ...
    <title>Tìm kiếm: <?php echo (!isset($_GET['s'])) ? '' : wjbu::safeget($_GET['s']) ?></title>
    <!-- Bootstrap core CSS-->
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Tìm kiếm: <?php echo (!isset($_GET['s'])) ? '' : wjbu::safeget($_GET['s']) ?></li>
          </ol>
