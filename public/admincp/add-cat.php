      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Thêm thể loại mới</li>
          </ol>
                ...
                <div class="row">
                  <div class="col-lg-9">
                    <div class="input-group input-group-sm mb-3">
                      ...
                      <input type="text" class="form-control" name="title" placeholder="Tên của thể loại" >
                    </div>
                    <div class="input-group input-group-sm mb-3">
                      <div class="input-group-prepend">
                        <span class="input-group-text">https://manga.ani4vn.com/cat/</span>
                      </div>
                      <input type="text" class="form-control" placeholder="Cài đặt đường dẫn cho thể loại">
                    </div>
                    ...
                    <div class="input-group mb-3">
                      ...
                      <textarea class="form-control" placeholder="Nội dung tóm tắt thể loại."></textarea>
                    </div>
                  </div>
                  <div class="col-lg-3">
